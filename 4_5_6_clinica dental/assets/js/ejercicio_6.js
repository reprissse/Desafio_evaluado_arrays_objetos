...
//filtrar pacientes TRAUMATOLOGÍA con FONASA
let pacientesTraumatologiaFonasa = traumatologia.filter(paciente => paciente.prevision === 'FONASA')

/************************************************************************* */

//nombres pacientes con previsión
let nombresDePacientes = pacientesTraumatologiaFonasa.map(paciente => `${paciente.paciente} - ${paciente.prevision}`)
