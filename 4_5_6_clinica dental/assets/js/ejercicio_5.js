...
//ejercicio 5 imprimir los pacientes con isapre
...
//filtrar pacientes Dental con ISAPRE
let pacientesDentalIsapre = dental.filter(paciente => paciente.prevision === 'ISAPRE')

/************************************************************************* */

//nombres pacientes con previsión
let nombresDePacientes = pacientesDentalIsapre.map(paciente => `${paciente.paciente} - ${paciente.prevision}`)
